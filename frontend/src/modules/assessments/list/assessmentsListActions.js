...
import exporterFields from 'modules/assessments/list/assessmentsListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'ASSESSMENTS_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await AssessmentsService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.assessments.exporterFileName'),
